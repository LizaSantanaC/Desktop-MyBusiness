...
public class Recursos {
    ...
    private static Recursos r;
    
    String CONTROLADOR = "com.mysql.jdbc.Driver";
    String URL = "jdbc:mysql://192.168.2.19:3306/consultorio";
    
    private Recursos(){}
    
    public synchronized static Recursos getRecursos(){
    ...
    public void llenarComboBox(String tabla, JComboBox<String> combo, int posicion) {
        ...
        InterfaceBD conexion = new InterfaceBD();
 ...
 ;
    ...
    public boolean validarDatosNumericos(JTextField...args){
     ...
     public boolean validarApellido(JTextField...args){
  
            for (JTextField caja : args) {
                for (int i = 0; i < caja.getText().length(); i++) {
                   if(!Character.isAlphabetic(caja.getText().charAt(i))){
                       return false;
                   }
                }
            }
