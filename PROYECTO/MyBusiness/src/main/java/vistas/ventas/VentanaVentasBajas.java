 ...
 * @author liza
 */
public class VentanaVentasBajas extends javax.swing.JFrame {
        ...
        if (r.componentesVacios(txtCodigo)) {
           ...
           v = vDAO.consultaVenta(txtCodigo.getText());
            ...
            if (v == null) {
                ...
                cbProducto.setSelectedItem(v.getCantidadProducto());
    ...
    private void btnProductoEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProductoEliminarActionPerformed
        ...
        if(uLogueado.isIsAdmin()){
            if (JOptionPane.showConfirmDialog(this, "Esta realmente seguro de eliminar la venta?") == 0) {
            if (vDAO.eliminarVenta(txtCodigo.getText())) {
                r.mostrarNotificacionInfo("Venta eliminado !!!", "Se ha eliminado la venta de la base de datos.");
             ...
             r.mostrarNotificacionCuidado("No se puede eliminar la venta", "Solo el administrador puede eliminar las ventas...");
        }
